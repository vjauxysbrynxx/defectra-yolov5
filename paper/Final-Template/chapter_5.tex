...
Based on the limitations encountered and the results obtained,the researchers have observed that there are lapses and possible improvements to further better this system.
...
\textit{Deep Learning Integration.} While this special problem used traditional stereo vision methods for depth estimation due to hardware and data constraints, future iterations could benefit from incorporating lightweight deep learning models for pothole detection and classification. Although not necessary for depth estimation alone, such models can enhance the system’s robustness in complex environments. A hybrid deep learning and stereo vision approach may also improve accuracy and enable broader defect classification.