...
\begin{enumerate}
	...
	\item Measure the accuracy of the system by comparing the depth measurements against ground truth data collected from actual road inspections and to utilize linear regression, root mean square error, and mean absolute error as a metric for evaluation, and
