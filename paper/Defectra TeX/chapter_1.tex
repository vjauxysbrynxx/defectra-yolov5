...
\begin{enumerate}
	...
	\item To measure the accuracy of the system by comparing the depth measurements against ground truth data collected from actual road inspections and to utilize linear regression as a metric for evaluation.
